...
danc_hist <- boot_plot(danc_cors, color_scheme[1], "<i style='color:#000000;'>\"...for dancing\"</i>", average_boots$danc_cors)
heal_hist <- boot_plot(heal_cors, color_scheme[2], "<i style='color:#000000;'>\"...to heal illness\"</i>", average_boots$heal_cors)
love_hist <- boot_plot(love_cors, color_scheme[3], "<i style='color:#000000;'>\"...to express love for<br>another person\"</i>", average_boots$love_cors)
baby_hist <- boot_plot(baby_cors, color_scheme[4], "<i style='color:#000000;'>\"...to soothe a baby\"</i>", average_boots$baby_cors)
